...
public class MainScreen extends ScreenAdapter {
    ...
    public void show()
    {
        ...
        audioTrack.play();
        Button easy = new TextButton("EASY",new Skin(Gdx.files.internal("uiskin.json")));
        Button normal = new TextButton("NORMAL",new Skin(Gdx.files.internal("uiskin.json")));
        Button hard = new TextButton("HARD",new Skin(Gdx.files.internal("uiskin.json")));
        Button expert = new TextButton("EXPERT",new Skin(Gdx.files.internal("uiskin.json")));
        Button expertplus = new TextButton("EXPERT+",new Skin(Gdx.files.internal("uiskin.json")));
        easy.setPosition(10,WORLD_HEIGHT - coverImg.getHeight()-20-easy.getHeight());
        normal.setPosition(easy.getX()+10+easy.getWidth(),WORLD_HEIGHT - coverImg.getHeight()-20-easy.getHeight());
        hard.setPosition(normal.getX()+10+normal.getWidth(),WORLD_HEIGHT - coverImg.getHeight()-20-easy.getHeight());
        expert.setPosition(hard.getX()+10+hard.getWidth(),WORLD_HEIGHT - coverImg.getHeight()-20-easy.getHeight());
        expertplus.setPosition(expert.getX()+10+expert.getWidth(),WORLD_HEIGHT - coverImg.getHeight()-20-easy.getHeight());
        stage.addActor(easy);
        stage.addActor(normal);
        stage.addActor(hard);
        stage.addActor(expert);
        stage.addActor(expertplus);
